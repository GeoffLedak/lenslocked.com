...
ssh root@142.93.86.14 "rm -rf /root/go/src/lenslocked.com"
...
rsync -avr --exclude '.git/*' --exclude 'tmp/*' \
  --exclude 'images/*' ./ \
  root@142.93.86.14:/root/go/src/lenslocked.com/
echo "  Code uploaded successfully!"

echo "  Go getting deps..."
ssh root@142.93.86.14 "export GOPATH=/root/go; \
...
echo "  Moving assets..."
ssh root@142.93.86.14 "cd /root/app; \
...
ssh root@142.93.86.14 "sudo service lenslocked.com restart"
echo "  Server restarted successfully!"

echo "  Restarting Caddy server..."
ssh root@142.93.86.14 "sudo service caddy restart"
